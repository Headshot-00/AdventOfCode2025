...
fn test_multiple_updates() {
    ...
    assert_eq!(acc.get_sum(), 11 + 22 + 33 + 44);
}
...
fn test_example() {
    ...
    assert_eq!(acc.get_sum(), 11 + 22 + 99);
    acc.update("998-1012").unwrap();
    assert_eq!(acc.get_sum(), 11 + 22 + 99 + 1010);
    acc.update("1188511880-1188511890").unwrap();
    assert_eq!(acc.get_sum(), 11 + 22 + 99 + 1010 + 1188511885);
    acc.update("222220-222224").unwrap();
    assert_eq!(acc.get_sum(), 11 + 22 + 99 + 1010 + 1188511885 + 222222);
